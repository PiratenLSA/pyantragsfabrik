...
urlpatterns = patterns('', url(r'^$', views.index, name='index'),
                       ...
                       url(r'^appl/(?P<application_id>\d+)/revision/(?P<revision>\d+)/$', views.appl_revision,
                           name='appl_revision'),
                       url(r'^appl/(?P<application_id>\d+)/history/$', views.appl_history, name='appl_history'),
                       url(r'^appl/(?P<application_id>\d+)/history/(?P<page>\d+)/$', views.appl_history,
                           name='appl_history_page'),
                       url(r'^appl/(?P<application_id>\d+)/diff/(?P<revision1>\d+)/(?P<revision2>\d+)/$',
                           views.appl_history_diff, name='appl_history_diff'),
                       ...
                       url(r'^appl/(?P<object_id>\d+)/vote/(?P<direction>up|down|clear)/$', vote_on_object, voting_dict,
                           name='appl-vote'), )